...
2. Download the the latest stable release [here](https://github.com/rockerbacon/modorganizer2-linux-installer/releases/download/4.6.1/mo2installer-4.6.1.tar.gz);
...
| Stardew Valley         | working       | working [see required post-isstall steps](https://github.com/rockerbacon/modorganizer2-linux-installer/blob/sdv-support/post-install.md#required-post-install-steps-for-stardew-valley) | N/A     |
